...
public final class UnifyConstant extends Op {

	public String constant;

	public UnifyConstant(DataInputStream dis) throws IOException {
		this(dis.readUTF());
	}

	public UnifyConstant(String constant) {
		super(Op.UCON);
	...
	public void execute(AbstractMachine machine) throws FailureException {
		machine.unifyConstant(constant);
	}
