...
public final class GetLevel extends Op {

	public final int permanentVariable;

	public GetLevel(DataInputStream dis) throws IOException {
		this(dis.readInt());
	}

	public GetLevel(int permanentVariable) {
		super(Op.GLVL);
	...
	public void execute(AbstractMachine machine) throws FailureException {
		machine.getLevel(permanentVariable);
	}
