...
public final class GetList extends Op {

	public final int argumentRegister;

	public GetList(DataInputStream dis) throws IOException {
		this(dis.readInt());
	}

	public GetList(int argumentRegister) {
		super(Op.GLST);
	...
	public void execute(AbstractMachine machine) throws FailureException {
		machine.getList(argumentRegister);
	}
}
