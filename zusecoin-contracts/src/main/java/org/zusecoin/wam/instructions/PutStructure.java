...
public final class PutStructure extends Op {

	public final int argumentRegister;

	public final String functor;

	public PutStructure(DataInputStream dis) throws IOException {
		this(dis.readUTF(), dis.readInt());
	}

	public PutStructure(String functor, int argumentRegister) {
		super(Op.PSTR);
	...
	public void execute(AbstractMachine machine) throws FailureException {
		machine.putStructure(functor, argumentRegister);
	}

	@Override
	public String toString() {
		return "PutStructure [argumentRegister=" + argumentRegister + ", functor=" + functor + "]";
	}
