...
public final class PutConstant extends Op {

	public final String constant;

	public final int argumentRegister;

	public PutConstant(DataInputStream dis) throws IOException {
		this(dis.readUTF(), dis.readInt());
	}

	public PutConstant(String constant, int argumentRegister) {
		super(Op.PCON);
