...
public final class PutValue extends Op {

	public final int argumentRegister;

	public final int variable;

	public PutValue(DataInputStream dis) throws IOException {
		this(dis.readInt(), dis.readInt());
	}

	public PutValue(int argumentRegister, int variable) {
		super(Op.PVAL);
	...
	public void execute(AbstractMachine machine) throws FailureException {
		machine.putValue(argumentRegister, variable);
	}
