...
public final class Execute extends Op {

	public final int instructionLabel;

	public Execute(DataInputStream dis) throws IOException {
		this(dis.readInt());
	}

	public Execute(int instructionLabel) {
		super(Op.EXE);
	...
	public void execute(AbstractMachine machine) throws FailureException {
		machine.execute(instructionLabel);
	}
}
