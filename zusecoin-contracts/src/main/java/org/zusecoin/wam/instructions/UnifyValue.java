...
public final class UnifyValue extends Op {

	public final int variable;

	public UnifyValue(DataInputStream dis) throws IOException {
		this(dis.readInt());
	}

	public UnifyValue(int variable) {
		super(Op.UVAL);
	...
	public void execute(AbstractMachine machine) throws FailureException {
		machine.unifyValue(variable);
	}

	@Override
	public String toString() {
		return "UnifyValue [variable=" + variable + "]";
	}
