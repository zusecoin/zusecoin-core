...
public final class PutList extends Op {

	public final int argumentRegister;

	public PutList(DataInputStream dis) throws IOException {
		this(dis.readInt());
	}

	public PutList(int argumentRegister) {
		super(Op.PLST);
	...
	public void execute(AbstractMachine machine) throws FailureException {
		machine.putList(argumentRegister);
	}
