...
public final class SetLocalValue extends Op {

	public final int variable;

	public SetLocalValue(DataInputStream dis) throws IOException {
		this(dis.readInt());
	}

	public SetLocalValue(int variable) {
		super(Op.SLVA);
	...
	public void execute(AbstractMachine machine) throws FailureException {
		machine.setLocalValue(variable);
	}
