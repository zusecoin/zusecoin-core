...
public final class Try extends Op {

	public final int instructionLabel;

	public Try(DataInputStream dis) throws IOException {
		this(dis.readInt());
	}

	public Try(int instructionLabel) {
		super(Op.TRY);
	...
	public void execute(AbstractMachine machine) throws FailureException {
		machine.tryInstruction(instructionLabel);
	}
