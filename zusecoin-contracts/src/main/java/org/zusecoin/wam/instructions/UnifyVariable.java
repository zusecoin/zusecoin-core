...
public final class UnifyVariable extends Op {

	public final int variable;

	public UnifyVariable(DataInputStream dis) throws IOException {
		this(dis.readInt());
	}

	public UnifyVariable(int variable) {
		super(Op.UVAR);
	...
	public void execute(AbstractMachine machine) throws FailureException {
		machine.unifyVariable(variable);
	}

	@Override
	public String toString() {
		return "UnifyVariable [variable=" + variable + "]";
	}
