...
public final class PutUnsafeValue extends Op {

	public final int permanentVariable;

	public final int argumentRegister;

	public PutUnsafeValue(DataInputStream dis) throws IOException {
		this(dis.readInt(), dis.readInt());
	}

	public PutUnsafeValue(int permanentVariable, int argumentRegister) {
		super(Op.PUVL);
	...
	public void execute(AbstractMachine machine) throws FailureException {
		machine.putUnsafeValue(permanentVariable, argumentRegister);
	}

	@Override
	public String toString() {
		return "PutUnsafeValue [permanentVariable=" + permanentVariable + ", argumentRegister=" + argumentRegister
				+ "]";
	}
