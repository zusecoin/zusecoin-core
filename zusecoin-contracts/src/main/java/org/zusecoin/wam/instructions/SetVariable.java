...
public final class SetVariable extends Op {

	public final int variable;

	public SetVariable(DataInputStream dis) throws IOException {
		this(dis.readInt());
	}

	public SetVariable(int variable) {
		super(Op.SVAR);
	...
	public String toString() {
		return "SetVariable [variable=" + variable + "]";
	}
