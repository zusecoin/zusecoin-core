...
public final class SetValue extends Op {

	public final int variable;

	public SetValue(DataInputStream dis) throws IOException {
		this(dis.readInt());
	}
	...
	public void execute(AbstractMachine machine) throws FailureException {
		machine.setValue(variable);
	}

	@Override
	public String toString() {
		return "SetValue [variable=" + variable + "]";
	}
