...
public final class SwitchOnStructure extends Op {

	public final Map<String, Integer> hash;

	public SwitchOnStructure(DataInputStream dis) throws IOException {
		super(Op.SOS);
	...
	public SwitchOnStructure(Map<String, Integer> hash) {
		super(Op.SOS);
		this.hash = hash;
	}
	...
	public void execute(AbstractMachine machine) throws FailureException {
		machine.switchOnStructure(hash);
	}
