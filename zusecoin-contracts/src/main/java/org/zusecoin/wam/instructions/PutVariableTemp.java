...
public final class PutVariableTemp extends Op {

	public final int argumentRegister;

	public final int register;

	public PutVariableTemp(DataInputStream dis) throws IOException {
		this(dis.readInt(), dis.readInt());
	}

	public PutVariableTemp(int register, int argumentRegister) {
		super(Op.PVAT);
	...
	public void execute(AbstractMachine machine) throws FailureException {
		machine.putVariableTemp(register, argumentRegister);
	}
