...
public final class RetryMeElse extends Op {

	public final int instructionLabel;

	public RetryMeElse(DataInputStream dis) throws IOException {
		this(dis.readInt());
	}

	public RetryMeElse(int instructionLabel) {
		super(Op.RTE);
	...
	public void execute(AbstractMachine machine) throws FailureException {
		machine.retryMeElse(instructionLabel);
	}
