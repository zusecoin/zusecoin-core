...
public final class SetConstant extends Op {

	public final String constant;

	public SetConstant(DataInputStream dis) throws IOException {
		this(dis.readUTF());
	}

	public SetConstant(String constant) {
		super(Op.SCON);
