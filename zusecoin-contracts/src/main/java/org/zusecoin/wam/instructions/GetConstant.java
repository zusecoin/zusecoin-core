...
public final class GetConstant extends Op {

	public final String value;

	public final int argumentRegister;

	public GetConstant(DataInputStream dis) throws IOException {
		this(dis.readUTF(), dis.readInt());
	}

	public GetConstant(String value, int argumentRegister) {
		super(Op.GCON);
		this.value = value;
	...
	public void execute(AbstractMachine machine) throws FailureException {
		machine.getConstant(value, argumentRegister);
	}

	@Override
	public String toString() {
		return "GetConstant [value=" + value + ", argumentRegister=" + argumentRegister + "]";
	}
