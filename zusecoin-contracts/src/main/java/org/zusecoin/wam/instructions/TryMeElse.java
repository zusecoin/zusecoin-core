...
public final class TryMeElse extends Op {

	public final int instructionLabel;

	public TryMeElse(DataInputStream dis) throws IOException {
		this(dis.readInt());
	}

	public TryMeElse(int instructionLabel) {
		super(Op.TME);
	...
	public void execute(AbstractMachine machine) throws FailureException {
		machine.tryMeElse(instructionLabel);
	}
