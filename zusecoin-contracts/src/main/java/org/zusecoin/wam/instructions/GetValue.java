...
public final class GetValue extends Op {

	public final int variable;

	public final int argumentRegister;

	public GetValue(DataInputStream dis) throws IOException {
		this(dis.readInt(), dis.readInt());
	}

	public GetValue(int variable, int argumentRegister) {
		super(Op.GVAL);
	...
	public void execute(AbstractMachine machine) throws FailureException {
		machine.getValue(variable, argumentRegister);
	}

	@Override
	public String toString() {
		return "GetValue [variable=" + variable + ", argumentRegister=" + argumentRegister + "]";
	}
